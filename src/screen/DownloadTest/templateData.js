export const testData = {
    // 桥梁id
    bridgeid: 'g114pkr3y2z001',
    // 桥梁名称
    bridgename: '测试桥梁-g114pkr3y2z001',
    // 桥梁类型
    bridgetype: 'bridge-g',
    // 桥梁桩号
    bridgestation: 'k500+g114pkr3y2z001',
    // 桥梁长度（浮点数），有上传(b16)
    b16: 0,
    ...
    structureInfo: [
        {
            ...
            memberid: 'g114pkr3y2z001_b100001_lz6c37cc_0',
        ...
        },
        {
            ...
            membertype: 'b100001',
            // 构件编号（字符串），有上传(structureInfo.memberData.memberid)
            memberid: 'g114pkr3y2z001_b100001_lz6c37cc_1',
            // 构件名称（字符串），有上传(structureInfo.memberData.membername)
            membername: '2-1#',
            // 跨编号（int），有上传(structureInfo.memberData.stepno)
            stepno: 2,
        ...
        },
        {
            ...
            membertype: 'b200001',
            // 构件编号（字符串），有上传(structureInfo.memberData.memberid)
            memberid: 'g114pkr3y2z001_b200001_lz6c37cc_2',
            // 构件名称（字符串），有上传(structureInfo.memberData.membername)
            membername: '0#台台身',
            // 跨编号（int），有上传(structureInfo.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b200001',
            // 构件编号（字符串），有上传(structureInfo.memberData.memberid)
            memberid: 'g114pkr3y2z001_b200001_lz6c37cc_3',
            // 构件名称（字符串），有上传(structureInfo.memberData.membername)
            membername: '0#台台帽',
            // 跨编号（int），有上传(structureInfo.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b200001',
            // 构件编号（字符串），有上传(structureInfo.memberData.memberid)
            memberid: 'g114pkr3y2z001_b200001_lz6c37cc_4',
            // 构件名称（字符串），有上传(structureInfo.memberData.membername)
            membername: '2#台台身',
            // 跨编号（int），有上传(structureInfo.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b200001',
            // 构件编号（字符串），有上传(structureInfo.memberData.memberid)
            memberid: 'g114pkr3y2z001_b200001_lz6c37cc_5',
            // 构件名称（字符串），有上传(structureInfo.memberData.membername)
            membername: '2#台台帽',
            // 跨编号（int），有上传(structureInfo.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b300003',
            // 构件编号（字符串），有上传(structureInfo.memberData.memberid)
            memberid: 'g114pkr3y2z001_b300003_lz6c37cc_6',
            // 构件名称（字符串），有上传(structureInfo.memberData.membername)
            membername: '左侧1#跨',
            // 跨编号（int），有上传(structureInfo.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b300003',
            // 构件编号（字符串），有上传(structureInfo.memberData.memberid)
            memberid: 'g114pkr3y2z001_b300003_lz6c37cc_7',
            // 构件名称（字符串），有上传(structureInfo.memberData.membername)
            membername: '左侧2#跨',
            // 跨编号（int），有上传(structureInfo.memberData.stepno)
            stepno: 2,
        ...
        },
        {
            ...
            membertype: 'b300003',
            // 构件编号（字符串），有上传(structureInfo.memberData.memberid)
            memberid: 'g114pkr3y2z001_b300003_lz6c37cc_8',
            // 构件名称（字符串），有上传(structureInfo.memberData.membername)
            membername: '右侧1#跨',
            // 跨编号（int），有上传(structureInfo.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b300003',
            // 构件编号（字符串），有上传(structureInfo.memberData.memberid)
            memberid: 'g114pkr3y2z001_b300003_lz6c37cc_9',
            // 构件名称（字符串），有上传(structureInfo.memberData.membername)
            membername: '右侧2#跨',
            // 跨编号（int），有上传(structureInfo.memberData.stepno)
            stepno: 2,
    ...
    //----- 测试数据 -----
    bridgereportid: 'g114pkr3y2z0014pkr3y24w7w',
    // 报告名
    ...
    bridge_report_member: [
        {
            ...
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b100001_lz6c37cc_0',
        ...
        },
        {
            ...
            membertype: 'b100001',
            // 构件编号，有上传(testData.detailTestData.memberData.memberid)
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b100001_lz6c37cc_1',
            // 构建名称，有上传(testData.detailTestData.memberData.membername)
            membername: '2-1#',
            // 跨编号，有上传(testData.detailTestData.memberData.stepno)
            stepno: 2,
        ...
        },
        {
            ...
            membertype: 'b200001',
            // 构件编号，有上传(testData.detailTestData.memberData.memberid)
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b200001_lz6c37cc_2',
            // 构建名称，有上传(testData.detailTestData.memberData.membername)
            membername: '0#台台身',
            // 跨编号，有上传(testData.detailTestData.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b200001',
            // 构件编号，有上传(testData.detailTestData.memberData.memberid)
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b200001_lz6c37cc_3',
            // 构建名称，有上传(testData.detailTestData.memberData.membername)
            membername: '0#台台帽',
            // 跨编号，有上传(testData.detailTestData.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b200001',
            // 构件编号，有上传(testData.detailTestData.memberData.memberid)
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b200001_lz6c37cc_4',
            // 构建名称，有上传(testData.detailTestData.memberData.membername)
            membername: '2#台台身',
            // 跨编号，有上传(testData.detailTestData.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b200001',
            // 构件编号，有上传(testData.detailTestData.memberData.memberid)
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b200001_lz6c37cc_5',
            // 构建名称，有上传(testData.detailTestData.memberData.membername)
            membername: '2#台台帽',
            // 跨编号，有上传(testData.detailTestData.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b300003',
            // 构件编号，有上传(testData.detailTestData.memberData.memberid)
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b300003_lz6c37cc_6',
            // 构建名称，有上传(testData.detailTestData.memberData.membername)
            membername: '左侧1#跨',
            // 跨编号，有上传(testData.detailTestData.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b300003',
            // 构件编号，有上传(testData.detailTestData.memberData.memberid)
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b300003_lz6c37cc_7',
            // 构建名称，有上传(testData.detailTestData.memberData.membername)
            membername: '左侧2#跨',
            // 跨编号，有上传(testData.detailTestData.memberData.stepno)
            stepno: 2,
        ...
        },
        {
            ...
            membertype: 'b300003',
            // 构件编号，有上传(testData.detailTestData.memberData.memberid)
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b300003_lz6c37cc_8',
            // 构建名称，有上传(testData.detailTestData.memberData.membername)
            membername: '右侧1#跨',
            // 跨编号，有上传(testData.detailTestData.memberData.stepno)
            stepno: 1,
        ...
        },
        {
            ...
            membertype: 'b300003',
            // 构件编号，有上传(testData.detailTestData.memberData.memberid)
            memberid: 'g114pkr3y2z0014pkr3y24w7w_b300003_lz6c37cc_9',
            // 构建名称，有上传(testData.detailTestData.memberData.membername)
            membername: '右侧2#跨',
            // 跨编号，有上传(testData.detailTestData.memberData.stepno)
            stepno: 1,
    ...
    bridge_report_data: [
        {
            ...
            version: 'g114pkr3y2z0014pkr3y24w7w_b100001_lz6c37cc_0_1',
        ...
        },
        {
            ...
            datatype: 'c1001',
            // 数据版本，病害唯一值，有上传(testData.detailTestData.memberData.diseaseData/goodData.version)，对应图片数据中的 dataid，用来确定图片
            version: 'g114pkr3y2z0014pkr3y24w7w_b100001_lz6c37cc_0_2',
            // 更新时间，有上传(testData.detailTestData.memberData.diseaseData/goodData.u_date)
            u_date: '2024-07-29 13:53:53',
            // 经度，有上传(testData.detailTestData.memberData.diseaseData/goodData.longitude)
            longitude: '',
        ...
        },
        {
            ...
            datatype: 'c1001',
            // 数据版本，病害唯一值，有上传(testData.detailTestData.memberData.diseaseData/goodData.version)，对应图片数据中的 dataid，用来确定图片
            version: 'g114pkr3y2z0014pkr3y24w7w_b100001_lz6c37cc_1_1',
            // 更新时间，有上传(testData.detailTestData.memberData.diseaseData/goodData.u_date)
        ...
        },
        {
            ...
            datatype: '',
            // 数据版本，病害唯一值，有上传(testData.detailTestData.memberData.diseaseData/goodData.version)，对应图片数据中的 dataid，用来确定图片
            version: 'g114pkr3y2z0014pkr3y24w7w_b200001_lz6c37cc_2_1',
            // 更新时间，有上传(testData.detailTestData.memberData.diseaseData/goodData.u_date)
        ...
        },
        {
            ...
            datatype: '',
            // 数据版本，病害唯一值，有上传(testData.detailTestData.memberData.diseaseData/goodData.version)，对应图片数据中的 dataid，用来确定图片
            version: 'g114pkr3y2z0014pkr3y24w7w_b200001_lz6c37cc_3_1',
            // 更新时间，有上传(testData.detailTestData.memberData.diseaseData/goodData.u_date)
            u_date: '2024-07-29 13:54:02',
            // 经度，有上传(testData.detailTestData.memberData.diseaseData/goodData.longitude)
            longitude: 106.82685801116266,
        ...
        },
        {
            ...
            datatype: '',
            // 数据版本，病害唯一值，有上传(testData.detailTestData.memberData.diseaseData/goodData.version)，对应图片数据中的 dataid，用来确定图片
            version: 'g114pkr3y2z0014pkr3y24w7w_b200001_lz6c37cc_4_1',
            // 更新时间，有上传(testData.detailTestData.memberData.diseaseData/goodData.u_date)
            u_date: '2024-07-29 13:54:02',
            // 经度，有上传(testData.detailTestData.memberData.diseaseData/goodData.longitude)
            longitude: 106.82685801116266,
        ...
        },
        {
            ...
            datatype: '',
            // 数据版本，病害唯一值，有上传(testData.detailTestData.memberData.diseaseData/goodData.version)，对应图片数据中的 dataid，用来确定图片
            version: 'g114pkr3y2z0014pkr3y24w7w_b200001_lz6c37cc_5_1',
            // 更新时间，有上传(testData.detailTestData.memberData.diseaseData/goodData.u_date)
            u_date: '2024-07-29 13:54:02',
            // 经度，有上传(testData.detailTestData.memberData.diseaseData/goodData.longitude)
            longitude: 106.82685801116266,
        ...
        },
        {
            ...
            datatype: '',
            // 数据版本，病害唯一值，有上传(testData.detailTestData.memberData.diseaseData/goodData.version)，对应图片数据中的 dataid，用来确定图片
            version: 'g114pkr3y2z0014pkr3y24w7w_b300003_lz6c37cc_7_1',
            // 更新时间，有上传(testData.detailTestData.memberData.diseaseData/goodData.u_date)
        ...
        },
        {
            ...
            datatype: '',
            // 数据版本，病害唯一值，有上传(testData.detailTestData.memberData.diseaseData/goodData.version)，对应图片数据中的 dataid，用来确定图片
            version: 'g114pkr3y2z0014pkr3y24w7w_b300003_lz6c37cc_8_1',
            // 更新时间，有上传(testData.detailTestData.memberData.diseaseData/goodData.u_date)
            u_date: '2024-07-29 13:54:12',
            // 经度，有上传(testData.detailTestData.memberData.diseaseData/goodData.longitude)
            longitude: 106.82685801116266,
    ...
    bridge_report_media: [
        {
            ...
            dataid: 'b100001',
            // 文件id，有上传(memberid)
            mediaid: "g114pkr3y2z0014pkr3y24w7w_1",
        ...
        },
        {
            ...
            dataid: 'b100001',
            // 文件id，有上传(memberid)
            mediaid: "g114pkr3y2z0014pkr3y24w7w_2",
            // 文件类型，有上传(type)，建议使用上传的type，桥梁图片(bridge)，部件图片(member)，良好构件图片(goodParts)，病害图片(diseaseParts)
            type: 'member',
            // ？ 分类，有上传(category)，建议使用上传的category，这里是后期改动的，可能和之前的数据对应不上
            category: 'member-b100001',
        ...
        {
            // 数据编号，有上传(dataid)，建议使用上传的dataid，桥梁图片(dataid=bridgeid)，部件图片(dataid=partid)，良好构件图片(dataid=构件的memberid)，病害图片(dataid=病害唯一值)
            dataid: 'g114pkr3y2z001',
            // 文件id，有上传(memberid)
            mediaid: "g114pkr3y2z0014pkr3y24w7w_3",
            // 文件类型，有上传(type)，建议使用上传的type，桥梁图片(bridge)，部件图片(member)，良好构件图片(goodParts)，病害图片(diseaseParts)
            type: 'bridge',
            // ？ 分类，有上传(category)，建议使用上传的category，这里是后期改动的，可能和之前的数据对应不上
            category: 'L0101',
        ...
        },
        {
            ...
            dataid: 'g114pkr3y2z001',
            // 文件id，有上传(memberid)
            mediaid: "g114pkr3y2z0014pkr3y24w7w_4",
            // 文件类型，有上传(type)，建议使用上传的type，桥梁图片(bridge)，部件图片(member)，良好构件图片(goodParts)，病害图片(diseaseParts)
            type: 'bridge',
            // ？ 分类，有上传(category)，建议使用上传的category，这里是后期改动的，可能和之前的数据对应不上
            category: 'L0101',
        ...
        },
        {
            ...
            dataid: 'g114pkr3y2z001',
            // 文件id，有上传(memberid)
            mediaid: "g114pkr3y2z0014pkr3y24w7w_41",
            // 文件类型，有上传(type)，建议使用上传的type，桥梁图片(bridge)，部件图片(member)，良好构件图片(goodParts)，病害图片(diseaseParts)
            type: 'bridge',
            // ？ 分类，有上传(category)，建议使用上传的category，这里是后期改动的，可能和之前的数据对应不上
            category: 'L0101',
        ...
        {
            // 数据编号，有上传(dataid)，建议使用上传的dataid，桥梁图片(dataid=bridgeid)，部件图片(dataid=partid)，良好构件图片(dataid=构件的memberid)，病害图片(dataid=病害唯一值)
            dataid: 'g114pkr3y2z0014pkr3y24w7w_b100001_lz6c37cc_0_2',
            // 文件id，有上传(memberid)
            mediaid: "g114pkr3y2z0014pkr3y24w7w_5",
            // 文件类型，有上传(type)，建议使用上传的type，桥梁图片(bridge)，部件图片(member)，良好构件图片(goodParts)，病害图片(diseaseParts)
            type: 'diseaseParts',
            // ？ 分类，有上传(category)，建议使用上传的category，这里是后期改动的，可能和之前的数据对应不上
            category: 'disease',
